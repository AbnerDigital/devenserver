...
-- Demon (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first demon addon'}, playerBuyAddonNPC, {premium = false, cost = 2000000, items = {}, outfit_female = 541, outfit_male = 542, addon = 1, storageID = 10069})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second demon addon'}, playerBuyAddonNPC, {premium = false, cost = 3000000, items = {}, outfit_female = 541, outfit_male = 542, addon = 2, storageID = 10070})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Dream Warden (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first dream warden addon'}, playerBuyAddonNPC, {premium = false, cost = 4000000, items = {}, outfit_female = 578, outfit_male = 577, addon = 1, storageID = 10071})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second dream warden addon'}, playerBuyAddonNPC, {premium = false, cost = 6000000, items = {}, outfit_female = 578, outfit_male = 577, addon = 2, storageID = 10072})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Glooth Engineer (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first glooth engineer addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{6103,1}}, outfit_female = 618, outfit_male = 610, addon = 1, storageID = 10073})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second glooth engineer addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{5882,100}}, outfit_female = 618, outfit_male = 610, addon = 2, storageID = 10074})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Champion (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first champion addon'}, playerBuyAddonNPC, {premium = false, cost = 90000000, items = {}, outfit_female = 632, outfit_male = 633, addon = 1, storageID = 10075})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second champion addon'}, playerBuyAddonNPC, {premium = false, cost = 100000000, items = {}, outfit_female = 632, outfit_male = 633, addon = 2, storageID = 10076})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Conjurer (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first conjurer addon'}, playerBuyAddonNPC, {premium = false, cost = 90000000, items = {}, outfit_female = 635, outfit_male = 634, addon = 1, storageID = 10077})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second conjurer addon'}, playerBuyAddonNPC, {premium = false, cost = 100000000, items = {}, outfit_female = 635, outfit_male = 634, addon = 2, storageID = 10078})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Beastmaster (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first beastmaster addon'}, playerBuyAddonNPC, {premium = false, cost = 190000000, items = {}, outfit_female = 636, outfit_male = 637, addon = 1, storageID = 10079})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second beastmaster addon'}, playerBuyAddonNPC, {premium = false, cost = 180000000, items = {}, outfit_female = 636, outfit_male = 637, addon = 2, storageID = 10080})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Chaos Acolyte (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first chaos acolyte addon'}, playerBuyAddonNPC, {premium = false, cost = 190000000, items = {}, outfit_female = 664, outfit_male = 665, addon = 1, storageID = 10081})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second chaos acolyte addon'}, playerBuyAddonNPC, {premium = false, cost = 180000000, items = {}, outfit_female = 664, outfit_male = 665, addon = 2, storageID = 10082})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Death Herald (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first death herald addon'}, playerBuyAddonNPC, {premium = false, cost = 190000000, items = {}, outfit_female = 666, outfit_male = 667, addon = 1, storageID = 10083})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second death herald addon'}, playerBuyAddonNPC, {premium = false, cost = 180000000, items = {}, outfit_female = 666, outfit_male = 667, addon = 2, storageID = 10084})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Ranger (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first ranger addon'}, playerBuyAddonNPC, {premium = false, cost = 200000000, items = {}, outfit_female = 683, outfit_male = 684, addon = 1, storageID = 10085})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second ranger addon'}, playerBuyAddonNPC, {premium = false, cost = 210000000, items = {}, outfit_female = 683, outfit_male = 684, addon = 2, storageID = 10086})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Ceremonial Garb (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first ceremonial garb addon'}, playerBuyAddonNPC, {premium = false, cost = 200000000, items = {}, outfit_female = 694, outfit_male = 695, addon = 1, storageID = 10087})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second ceremonial garb addon'}, playerBuyAddonNPC, {premium = false, cost = 210000000, items = {}, outfit_female = 694, outfit_male = 695, addon = 2, storageID = 10088})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Puppeteer (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first puppeteer addon'}, playerBuyAddonNPC, {premium = false, cost = 200000000, items = {}, outfit_female = 696, outfit_male = 697, addon = 1, storageID = 10089})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second puppeteer addon'}, playerBuyAddonNPC, {premium = false, cost = 210000000, items = {}, outfit_female = 696, outfit_male = 697, addon = 2, storageID = 10090})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Spirit Caller(done)(custom)
local outfit_node = keywordHandler:addKeyword({'first spirit caller addon'}, playerBuyAddonNPC, {premium = false, cost = 200000000, items = {}, outfit_female = 698, outfit_male = 699, addon = 1, storageID = 10091})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second spirit caller addon'}, playerBuyAddonNPC, {premium = false, cost = 210000000, items = {}, outfit_female = 698, outfit_male = 699, addon = 2, storageID = 10092})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
	
-- Evoker(done)(custom)
local outfit_node = keywordHandler:addKeyword({'first evoker addon'}, playerBuyAddonNPC, {premium = false, cost = 200000000, items = {}, outfit_female = 724, outfit_male = 725, addon = 1, storageID = 10093})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second evoker addon'}, playerBuyAddonNPC, {premium = false, cost = 210000000, items = {}, outfit_female = 724, outfit_male = 725, addon = 2, storageID = 10094})
	outfit_node:addChildKeywordNode(yesNode)
	outfit_node:addChildKeywordNode(noNode)



keywordHandler:addKeyword({'addons'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I sell mage, nobleman, warrior, barbarian, druid, wizard, oriental, assassin, shaman, nighmare, jester, yalaharian, warmaster, wayfarer, afflicted, deepling, insectoid, crystal warlord, soil guardian,cave explorer, dream Warden, Glooth Engineer, Champion, Conjurer, Beastmaster, Chaos Acolyte, Death Herald, Ranger, Ceremonial Garb, Puppeteer, Spirit Caller, And Evoker addons.'})
